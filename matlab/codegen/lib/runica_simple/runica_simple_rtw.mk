###########################################################################
## Makefile generated for component 'runica_simple'. 
## 
## Makefile     : runica_simple_rtw.mk
## Generated on : Sun Dec 28 17:44:58 2025
## Final product: ./runica_simple.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/runica_simple -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=runica_simple
...
SRCS = $(START_DIR)/codegen/lib/runica_simple/rt_nonfinite.c $(START_DIR)/codegen/lib/runica_simple/rtGetNaN.c $(START_DIR)/codegen/lib/runica_simple/rtGetInf.c $(START_DIR)/codegen/lib/runica_simple/runica_simple.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o runica_simple.o
...
%.o : $(START_DIR)/codegen/lib/runica_simple/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/runica_simple/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/runica_simple/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/runica_simple/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/runica_simple/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/runica_simple/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/runica_simple/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/runica_simple/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


runica_simple.o : $(START_DIR)/codegen/lib/runica_simple/runica_simple.c
	$(CC) $(CFLAGS) -o "$@" "$<"
